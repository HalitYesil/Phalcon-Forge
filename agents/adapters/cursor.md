...
Bu belge `agents/common/policy.md` icin Cursor odakli esleme dokumanidir.

## Uygulama Notlari

- Plan gerekiyorsa once plan olustur, sonra uygulamaya gec.
- Kod degisikligi oncesi dosya baglamini oku.
